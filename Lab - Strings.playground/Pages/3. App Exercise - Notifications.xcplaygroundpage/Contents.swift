 ...
 */
let firstName = "Lenayah"
let lastName = " Fanesie"
...
let congratulations  = ""
print("Congratulations, \(firstName) ! You beat your previous daily high score of \(previousBest) steps by walking \(newBest) ")
